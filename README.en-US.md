...
<p>I had an article published in the Brazilian Symposium on Informatics in Education, I completed the Ignite course at Rocketseat and I am currently studying at the Federal University of Rio Grande do Norte (UFRN). I specialize in ReactJS, Node, Next, JavaScript and TypeScript.</p>
...
<div id="list">
<div id="grid-item">
  <h4 class="item-title">Project: Highlight (<a href="https://core.l-marcel.vercel.app/?path=/story/highlight-examples--editable-with-plugin" taget="_blank">demonstration</a>)</h4>
  <ul>
    <li><p>
...
<div id="list">
<div id="grid-item">
  <h4 class="item-title">Project: Tailwind Factory (<a href="https://www.npmjs.com/package/tailwind-factory" taget="_blank">documentation</a>)</h4>
  <ul>
    <li><p>
